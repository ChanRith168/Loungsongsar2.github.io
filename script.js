        ...
        if(number.value <= 0) {
          ...
          $(document).ready(function() {
            swal({
                ...
                text: "complete any words and number!",
                icon: "error",
                button: "Try again!",
              });              
          });
...
document.getElementById("btn_nonum").addEventListener('click',()=> {
    const txt = document.getElementById('word');
    const number = document.getElementById("num");
    var getResult = ' ';
    var nonetag = ' ';
    ...
    if(txt.value != "" && number.value != ""){
        if(number.value <= 0) {
          ...
          $(document).ready(function() {
            swal({
                title: "Please Complete form!",
                text: "complete any word and number!",
                icon: "error",
                button: "Try again!",
              });              
          });
 ...
 document.getElementById("btn_refresh").addEventListener('click',()=> {
    document.getElementsByClassName("result")[0].innerHTML =  "Result will show here.";
